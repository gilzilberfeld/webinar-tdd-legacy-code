...
describe('characterization tests', function () {
    ...
    it('failures', function () {
        ...
        pressing_should_show("03", "3");
        pressing_should_show("6/3=", "2");
        pressing_should_show("X", "0");
        pressing_should_show("%", "0");
    });
    it('should fail but works', function () {
        pressing_should_show("3++", "3");
    });
});
...
//# sourceMappingURL=CharacterizationTests2.js.map